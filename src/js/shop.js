...
products.products.forEach(product => {
    ...
    <div class="price">${product.price.toFixed(2)} CHF</div>
    <h2>${product.name}</h2>
    <p>${product.description}</p>
    <div class="skuNumber"> Sku-Nummer: ${product.sku.toFixed(0)}</div>
    <div class="likes">Gefällt ${product.likes_count} Kunden</div>
  `;
